...
// //sets session variables if client logged in
// if(isset($_SESSION['client']) ){
//     $usernameC = $_SESSION['clientUsername'];);
// } 

// //sets session variables if trainer logged in
...
$workouts = "SELECT * FROM `GymafiWorkoutsUpload` WHERE workoutStyle = 'Calisthenics'";
    ...
    <div class="row">
        ...
        <div class="col-md-8">
                <div class="BlogTitleText">
                    <h1 style="color:white">Calisthenics Workouts 
                    </h1>
                </div>

            <!-- Automated Post Entries with PHP -->
        <?php
