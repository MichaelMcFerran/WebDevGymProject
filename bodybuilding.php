...
$workouts = "SELECT * FROM `GymafiWorkoutsUpload` WHERE workoutStyle = 'BodyBuilding'";
...
<head>
    ...
    <title>BodyBuilding Workouts</title>
...
<div class="container">
    ...
    <div class="col-md-8">
            <div class="BlogTitleText">
                <h1 style="color:white">BodyBuilding Workouts 
                </h1>
            </div>

        <!-- Automated Post Entries from PHP -->
    <?php
